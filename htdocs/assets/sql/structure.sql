...
-- Table  biographies
----
CREATE TABLE 'biographies' ('biography_id' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, 'text' TEXT, 'skin' TEXT, 'background' TEXT, 'font' TEXT, 'published' BOOLEAN DEFAULT 0, 'blocked' BOOLEAN DEFAULT 0);